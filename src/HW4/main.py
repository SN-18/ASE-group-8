...
if __name__ == '__main__':
    ...
    eg('copy', 'check copy', copy_test_13, help)
    eg('repcols', 'checking repcols', repcols_test_14, help)
    eg('synonyms', 'checking repcols cluster', synonyms_test_15, help)
    eg('reprows', 'checking reprows', reprows_test_16, help)
    eg('prototypes', 'checking reprows cluster', prototypes_test_17, help)
    eg('position', 'where is wally', position_test_18, help)
    eg('every', 'the whole enchilada', every_test_19, help)
